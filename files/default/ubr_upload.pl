...
my $UBER_VERSION = "6.3.1";                   # Version of UU
...
if(open REDIRECT, ">", "$redirect_file"){
	...
	# HWD MODIFICATION: Decode ampersands and append last variable
	my $url = $config{'redirect_url'};
	$url =~ s/&amp;/&/gi;
	my $redirect_url = $url . "&upload_id=" . $UPLOAD_ID;
